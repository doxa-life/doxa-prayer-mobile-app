...
plugins {
    ...
    // Firebase Crashlytics. google-services must be applied so the plugin can read the
    // per-flavor google-services.json (see android/app/src/<flavor>/google-services.json).
