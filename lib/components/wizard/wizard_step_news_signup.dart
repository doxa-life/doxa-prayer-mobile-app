...
class _WizardStepNewsSignupState extends State<WizardStepNewsSignup> {
  ...
  Widget build(BuildContext context) {
    ...
    // wizard Scaffold) rather than shrinking it; FillViewportScrollView adds
    // scroll padding equal to the keyboard height so the buttons can be
    // scrolled up above the keyboard without dismissing it, while staying
    // pinned to the bottom when there is room.
